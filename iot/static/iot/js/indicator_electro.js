...
function onConnect() {
    ...
    client.subscribe(topic);
         ...
         $("#seven-seg-array_v").sevenSeg({ digits: 5, value: 0000, decimalPoint: true });
		 $("#seven-seg-array_p").sevenSeg({ digits: 5, value: 0000, decimalPoint: true });
         $("#seven-seg-array_e").sevenSeg({ digits: 5, value: 0000, decimalPoint: true });
...
let payload = JSON.parse(message.payloadString);
    document.getElementById("messages").innerHTML += '<span>Topic: ' + message.destinationName + '  '+ message.payloadString +'| '  + '</span><br/>';
	 ...
	 $("#seven-seg-array_v").sevenSeg({ digits: 4, value: payload["current"], decimalPoint: true });
	 	 $("#seven-seg-array_p").sevenSeg({ digits: 4, value: payload["power"] });
	 $("#seven-seg-array_e").sevenSeg({ digits: 4, value: payload["energy"], decimalPoint: true });
