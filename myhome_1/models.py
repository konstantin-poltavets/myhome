...
class electrometr(models.Model):
    param = models.CharField(max_length=100)
    created_date = models.DateTimeField(default=timezone.now)
    measured_time = models.CharField(max_length=100)
    current = models.DecimalField(max_digits=10, decimal_places=3)
...
class electrozones(models.Model):
    created_date = models.DateField(unique=True, blank=False)
    energy_day = models.DecimalField(max_digits=10, decimal_places=3)
    energy_night = models.DecimalField(max_digits=10, decimal_places=3)
    ...
    @property
    def energy_all(self):
        return self.energy_day +  self.energy_night    
